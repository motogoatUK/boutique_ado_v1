...
ALLOWED_HOSTS = [
    ...
    'boutique-wt-6e09f019b9e2.herokuapp.com',
]
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'boutique-wt-6e09f019b9e2'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'boutiqueado@motogoat.co.uk'
else:
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
    EMAIL_USE_TLS = True
    EMAIL_PORT = 587
    EMAIL_HOST = 'mail.motogoat.co.uk'
